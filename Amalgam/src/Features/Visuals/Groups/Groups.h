...
Enum(ESP, Name = 1 << 0, Box = 1 << 1, Distance = 1 << 2, Bones = 1 << 3, HealthBar = 1 << 4, HealthText = 1 << 5, UberBar = 1 << 6, UberText = 1 << 7, ClassIcon = 1 << 8, ClassText = 1 << 9, WeaponIcon = 1 << 10, StaticWeaponText = 1 << 11, WeaponText = 1 << 12, Priority = 1 << 13, Labels = 1 << 14, Buffs = 1 << 15, Debuffs = 1 << 16, Flags = 1 << 17, LagCompensation = 1 << 18, Ping = 1 << 19, KDR = 1 << 20, Owner = 1 << 21, Level = 1 << 22, AmmoBars = 1 << 23, AmmoText = 1 << 24, IntelReturnTime = 1 << 25)
